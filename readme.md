...
❗️ Replace `AlbinaSte` with your GitHub username and copy the links to the `Pull Request` description:

- [DEMO LINK](https://AlbinaSte.github.io/layout_product-cards/)
- [TEST REPORT LINK](https://AlbinaSte.github.io/layout_product-cards/report/html_report/)
